...
export default function Polarion() {
  ...
  return (
    <>
    <Header/>
    <div className="polarionContainer">
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h1 className="text-left">Polarion ALM </h1>
            <h2 className="text-left">
              Polarion® ALM™ — Application Lifecycle Management Solution
            </h2>
          </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h1 className="text-primary">Discover our products</h1>
        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-4">
            ...
            <h3 className="text-warning">Manufacturing</h3>
            <p className="text-secondary plmpara">
          ...
          <div className="col-12 col-lg-4">
            ...
            <h3 className="text-warning">Life Cycle Management</h3>
            <p className="text-secondary plmpara">
        ...
        <div className="row">
        <div className="col-12">
          <h3 className="text-primary">Ready to learn more?</h3>
          <p className="text-secondary">
